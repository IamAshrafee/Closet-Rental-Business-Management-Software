  ...
  return (
    <>
      <motion.div
        ...
        whileTap={{ scale: 0.98 }}
        onClick={onClick}
        className="relative bg-white rounded-xl shadow-sm hover:shadow-md transition-all duration-300 ease-in-out cursor-pointer flex h-44 border border-gray-200/80 overflow-hidden group"
