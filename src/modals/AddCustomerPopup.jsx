        ...
        <div className="space-y-6 overflow-y-auto p-6 flex-grow">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              ...
              <input type="text" id="customerName" className="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm p-2" />
            </div>

            {/* Phone Number */}
            <div>
              <label htmlFor="phoneNumber" className="block text-sm font-medium text-gray-700">Phone Number</label>
              <input type="text" id="phoneNumber" className="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm p-2" />
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              ...
              <input type="text" id="altPhoneNumber" className="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm p-2" />
            </div>
            ...
            <div>
              ...
              <input type="text" id="nid" className="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm p-2" />
            </div>
          </div>
          ...
          <div>
            ...
            <div className="mt-2 flex items-center gap-4">
                <div className="flex items-center">
                    <input type="radio" id="fatherNid" name="parentNid" value="father" className="focus:ring-indigo-500 h-4 w-4 text-indigo-600 border-gray-300" />
                    <label htmlFor="fatherNid" className="ml-2 block text-sm font-medium text-gray-700">Father</label>
                </div>
                <div className="flex items-center">
                    <input type="radio" id="motherNid" name="parentNid" value="mother" className="focus:ring-indigo-500 h-4 w-4 text-indigo-600 border-gray-300" />
                    <label htmlFor="motherNid" className="ml-2 block text-sm font-medium text-gray-700">Mother</label>
                </div>
            </div>
            <input type="text" id="parentNidInput" className="mt-2 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm p-2" />
          </div>
          ...
          <div>
            ...
            <input type="text" id="husbandNid" className="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm p-2" />
          </div>
          ...
          <div>
            ...
            <input type="url" id="fbId" className="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm p-2" />
          </div>
